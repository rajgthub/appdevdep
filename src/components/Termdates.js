  ...
  return (
    <div className='col s12 homeWrapper'>
      ...
      <ul className=" list grey-text text-darken-2">
        <li>
          <i className=" tiny material-icons">child_care</i>Tuesday 4 Sept – Fri
          19 Oct{" "}
        </li>
        <li>
          <i className=" tiny material-icons">child_care</i>Mon 22 Oct – Fri 26
          Oct 1 week half term closed
        </li>
        <li>
          <i className=" tiny material-icons">child_care</i>Mon 29 Oct – Fri 14
          Dec{" "}
        </li>
        <li>
          <i className=" tiny material-icons">child_care</i>Mon 17 Dec – Fri 4
          Jan 3 weeks Christmas closed
        </li>
      </ul>
      ...
      <ul className=" list grey-text text-darken-2">
        <li>
          <i className=" tiny material-icons">child_care</i>Tuesday 8 Jan –Fri
          15 Feb{" "}
        </li>
        <li>
          <i className=" tiny material-icons">child_care</i>Mon 18 Feb – Fri 22
          Feb 1 week half term closed
        </li>
        <li>
          <i className=" tiny material-icons">child_care</i>Mon 25 Feb – Fri 5
          April{" "}
        </li>
        <li>
          <i className=" tiny material-icons">child_care</i>Fri 8 April – Fri 19
          Apr 2 weeks Easter closed
        </li>
      </ul>
      ...
      <ul className=" list grey-text text-darken-2">
        <li>
          <i className=" tiny material-icons">child_care</i>Tue 23 Apr – Fri 24
          May{" "}
        </li>
        <li>
          <i className=" tiny material-icons">child_care</i>6th May is a Bank
          Holiday
        </li>
        <li>
          <i className=" tiny material-icons">child_care</i>Mon 27 May – 31 May
          1 week half term closed
        </li>
        <li>
